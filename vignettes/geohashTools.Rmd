...
```{r merlion_nbhd, fig.width = 6, fig.height = 6, out.width = '\\textwidth'}
library(sf)
...
```{r meuse, fig.width = 6, fig.height = 6, out.width = '\\textwidth'}
...
```{r meuse_covering_plot, fig.width = 6, fig.height = 6, out.width = '\\textwidth'}
ggplot() +
...
```{r meuse_minimal, fig.width = 6, fig.height = 6, out.width = '\\textwidth'}
