test_that('gh_to_sp works', {
  ...
  expect_identical(ghSP['mk2u', ]@polygons[[1L]]@Polygons[[1L]]@coords,
...
test_that('gh_to_spdf.default works', {
  ...
  expect_identical(ghSPDF['tzy2', ]@polygons[[1L]]@Polygons[[1L]]@coords,
  ...
  expect_identical(ghSPDF2@data, DF)
})
...
test_that('gh_to_sf works', {
  ...
  expect_identical(ghSF$geometry[1L][[1L]][[1L]],
...
test_that('gh_covering works', {
  ...
  expect_identical(sort(rownames(banjarmasin_cover@data))[1:10],
  ...
  expect_identical(sort(rownames(banjarmasin_tight@data))[1:10],
...
test_that('gh_covering_sf works', {
  ...
  expect_false(anyNA(vapply(sf::st_intersects(banjarmasin, banjarmasin_cover),
                            ...
                            integer(1L))))
  expect_identical(sort(rownames(banjarmasin_cover))[1:10],
               c('qx3kzj', 'qx3kzm', 'qx3kzn', 'qx3kzp', 'qx3kzq',
                 'qx3kzr', 'qx3kzt', 'qx3kzv', 'qx3kzw', 'qx3kzx'))
  ...
  banjarmasin_tight = gh_covering(banjarmasin, minimal = TRUE)
  expect_identical(sort(rownames(banjarmasin_tight))[1:10],
               c('qx3kzm', 'qx3kzx', 'qx3mp3', 'qx3mpb', 'qx3mpu',
                 'qx3mpz', 'qx3mr5', 'qx3sbt', 'qx3t06', 'qx3t22'))
