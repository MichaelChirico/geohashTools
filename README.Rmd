...
cat(sprintf('
![logo](logo.png "%1$s")
[![codecov](http://codecov.io/github/%2$s/coverage.svg?branch=master)](https://codecov.io:443/github/%2$s?branch=master)
[![travis](https://travis-ci.org/%2$s.svg?branch=master)](https://travis-ci.org/%2$s)
